...
**help** [**-all** | _commandname_ [**-usage**]] 

* * *

## DESCRIPTION

This command prints the formatted manual page for the given _commandname_. Soar's help facility is able to do command completion, so as long as a unique substring of the commandname is specified, Soar will find and display the help page.
