@rem
@rem Setup environment variables used in building the soar tools
@rem
@
@rem Each user should set these to the appropriate values for their system.
@
@rem Paths should not include a trailing "\" (e.g. set VC6=c:\visual6)
